...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	light->SetPosition(0.0f, 3.0, -5.0f);
	...
	//Text
	m_font.reset(new SpriteFont(direct3D->GetDevice(), L"./Assets/font.spritefont"));
...
void GraphicsClass::RegenrateTerrain()
{
	...
	terrain = new GeometryData(direct3D->GetDevice(), direct3D->GetDeviceContext(), &tree);
	//terrain->worldMatrix = XMMatrixIdentity() * XMMatrixScaling(10.0f, 10.0f, 10.0f);
	terrain->worldMatrix = XMMatrixIdentity();
}